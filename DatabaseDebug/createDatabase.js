...
postgresClient.query("CREATE TABLE photos(photo_id BIGSERIAL PRIMARY KEY,user_id BIGSERIAL,date_added DATE,photo_width FLOAT,photo_height FLOAT,completeImage BYTEA,layer_id TEXT)");
